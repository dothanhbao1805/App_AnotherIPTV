...
import com.example.anotheriptv.databinding.ItemLiveXstreamBinding
import com.example.anotheriptv.R

class ItemLiveXstreamAdapter(
    private val onChannelClick: (Channel) -> Unit
) : ListAdapter<Channel, ItemLiveXstreamAdapter.ViewHolder>(DiffCallback()) {

    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        val binding = ItemLiveXstreamBinding.inflate(
    ...
    inner class ViewHolder(
        private val binding: ItemLiveXstreamBinding
