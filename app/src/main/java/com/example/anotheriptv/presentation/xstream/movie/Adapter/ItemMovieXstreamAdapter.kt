...
import com.example.anotheriptv.databinding.ItemMovieXstreamBinding
import com.example.anotheriptv.domain.model.Channel

class ItemMovieXstreamAdapter(
    private val onChannelClick: (Channel) -> Unit
) : ListAdapter<Channel, ItemMovieXstreamAdapter.ViewHolder>(DiffCallback()) {

    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        val binding = ItemMovieXstreamBinding.inflate(
    ...
    inner class ViewHolder(
        private val binding: ItemMovieXstreamBinding
